...
createProp("tu154/custom/xap/KLN90/graphNAV5Comp", "string", 2048," ");
createProp("tu154/custom/xap/KLN90/graphAPT3Comp", "string", 2048," ");
-- Serialized string datarefs for text -- 
createProp("tu154/custom/xap/KLN90/gline_1", "string", 256,"WAIT FOR MASTER");
createProp("tu154/custom/xap/KLN90/gline_2", "string", 256,"WAIT FOR MASTER");
createProp("tu154/custom/xap/KLN90/gline_3", "string", 256,"WAIT FOR MASTER");
createProp("tu154/custom/xap/KLN90/gline_4", "string", 256,"WAIT FOR MASTER");
createProp("tu154/custom/xap/KLN90/gline_5", "string", 256,"WAIT FOR MASTER");
createProp("tu154/custom/xap/KLN90/gline_6", "string", 256,"WAIT FOR MASTER");
createProp("tu154/custom/xap/KLN90/gline_7", "string", 256,"WAIT FOR MASTER");
createProp("tu154/custom/xap/KLN90/bline_1", "string", 256,"WAIT FOR MASTER");
createProp("tu154/custom/xap/KLN90/bline_2", "string", 256,"WAIT FOR MASTER");
createProp("tu154/custom/xap/KLN90/bline_3", "string", 256,"WAIT FOR MASTER");
createProp("tu154/custom/xap/KLN90/bline_4", "string", 256,"WAIT FOR MASTER");
createProp("tu154/custom/xap/KLN90/bline_5", "string", 256,"WAIT FOR MASTER");
createProp("tu154/custom/xap/KLN90/bline_6", "string", 256,"WAIT FOR MASTER");
createProp("tu154/custom/xap/KLN90/bline_7", "string", 256,"WAIT FOR MASTER");
createProp("tu154/custom/xap/KLN90/scale_line", "string", 256," ");
createProp("tu154/custom/xap/KLN90/cage", "int", 0);

defineProperty("show_gns", globalPropertyi("tu154/custom/anim/show_gns"))

-- Aircraft power bus 
createProp("tu154/custom/kln_power", "int", 1);
...
defineProperty("kln_knob_out", globalPropertyi("tu154/custom/switchers/kln_knob_out")) --   
defineProperty("kln_power_knob", globalPropertyi("tu154/custom/switchers/kln_power_knob")) --    
...
------------------------------------------------------------------------------------
-- Tu154 ABSU
defineProperty("kln_course", globalPropertyf("tu154/custom/kln90/kln_course")) --    
defineProperty("kln_dev", globalPropertyf("tu154/custom/kln90/kln_dev")) --   , 
defineProperty("kln_flag", globalPropertyi("tu154/custom/kln90/kln_flag")) --   . 0 = 
--------------------------------------
--------------------------------------
...
defineProperty("MD41test", globalPropertyi("tu154/custom/xap/MD41/test"))
...
defineProperty("HSIOBS", globalPropertyf("sim/cockpit2/radios/actuators/hsi_obs_deg_mag_pilot")) -- manual course selector
--defineProperty("HSIOBS", globalPropertyf("tu154/custom/gauges/compas/pkp_obs_L")) --    defineProperty("HSIOBS", globalPropertyf("tu154/custom/gauges/compas/pkp_obs_set_L"))  -- set the course
...
defineProperty("GPSmode", globalPropertyi("tu154/custom/xap/KLN90/OBS"))
defineProperty("OBSreq", globalPropertyi("tu154/custom/xap/MD41/OBSreq"))
defineProperty("APR", globalPropertyi("tu154/custom/xap/KLN90/APR"))
...
defineProperty("Flash", globalPropertyi("tu154/custom/xap/KLN90/Flash"))
...
KLN90_panel = contextWindow {
	...
	components = {
		KLN90_2d_panel {
			position = { 0, 0, 733 * coef, 235 * coef },
			...
			Nav5Comp_tbl = function()
				return Nav5Comp
			end;
			APT3Comp_tbl = function()
				return APT3Comp
			end;
		};
		textureLit {
			position = {(733 - 16) * coef, (235 - 16) * coef, 16 * coef, 16 * coef},
...
function string2tex(tables, strings, x, y, size)
	...
	while num1 <= 5 do
    local char = string.sub(strings, num1, num1)

    if round(x - 2.5) > size[1]
        and round(x + 2.5) < size[1] + size[3]
        and round(y - 3.5) > size[2]
        and round(y + 3.5) < size[2] + size[4]
        and char ~= " " then
...
function WPTpage(types, mode, subpage)
					...
					if not (lpage == 7 and lsubpage[7] < 10) and not (lpage == 6 and lsubpage[6] == 40 and controls["lCRSR"]  == 1)	then
						...
						elseif rpage == 2 then
							...
							elseif controls["DCT"] >= 1 then
										...
										if values["GPSnum"] >= 4 then
											...
											if values["activeWPT"]["length"] >= 2 then
												...
												if values["primary"] == 1 then
													...
													if get(show_gns) == 0 then set(GPShdefout, 0) set(GPSfromtoout, 0) end
								...
								if rpage == -4 then
									if get(show_gns) == 0 then set(GPShdefout, 1.25) set(GPSfromtoout, 2) end
	...
	--print(values["DTK"], "  ", values["XTK"], "  ")
	
	-- set results for Tu154 ABSU
	if power == 1 then
	...
	-- knob animation
	set(kln_power_knob, power_knob)
	set(kln_knob_out, controls["SCAN"])
...
interactive {
	position = { 10, 10, size[1] - 20, size[2] - 20 },
...
color = {0,0.85,0.05},
brt2 = function() 
	if get(kln_power_knob) * get(kln_power) == 0 then
		return 0
	else
		return brt / 10
	end
