...
local bg_img = loadImage("load_panel.png")
local bg_img_rus = loadImage("load_panel_RUS.png")
...
-- Modern X-Plane float array elements use SASL 3 array-element bindings.
defineProperty("gear1_deflect", globalPropertyfae("sim/flightmodel2/gear/tire_vertical_deflection_mtr", 0))
defineProperty("fuel_q_1", globalPropertyfae("sim/flightmodel/weight/m_fuel", 0))
defineProperty("fuel_q_4", globalPropertyfae("sim/flightmodel/weight/m_fuel", 1))
defineProperty("fuel_q_2R", globalPropertyfae("sim/flightmodel/weight/m_fuel", 2))
defineProperty("fuel_q_2L", globalPropertyfae("sim/flightmodel/weight/m_fuel", 3))
defineProperty("fuel_q_3R", globalPropertyfae("sim/flightmodel/weight/m_fuel", 4))
defineProperty("fuel_q_3L", globalPropertyfae("sim/flightmodel/weight/m_fuel", 5))
