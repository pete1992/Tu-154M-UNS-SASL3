...
-- controls
defineProperty("pitch_corr_hdl", globalPropertyf("tu154/custom/gauges/ahz/pitch_corr_C")) --     + 
...
defineProperty("bus36_volt_pts250_1", globalPropertyf("tu154/custom/elec/bus36_volt_pts250_1"))
...
-- results
defineProperty("res_pitch", globalPropertyf("tu154/custom/gauges/ahz/pitch_C")) --    +  
defineProperty("res_roll", globalPropertyf("tu154/custom/gauges/ahz/roll_C")) --    +  

defineProperty("agr_cc", globalPropertyf("tu154/custom/ahz/agr_cc")) -- 

defineProperty("ahz_flag", globalPropertyf("tu154/custom/gauges/ahz/ahz_flag_C")) --    +  
