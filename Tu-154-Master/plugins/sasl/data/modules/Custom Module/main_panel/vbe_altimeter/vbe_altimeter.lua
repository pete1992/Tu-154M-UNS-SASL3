...
defineProperty("pressure", globalPropertyf("tu154/custom/gauges/alt/vbe_press_left"))  -- pressure in hPa
defineProperty("brt_knob", globalPropertyf("tu154/custom/gauges/alt/vbe_brt_left"))  -- brightness knob
defineProperty("press_knob", globalPropertyi("tu154/custom/gauges/alt/vbe_press_knob_left"))  -- pressure knob
defineProperty("fl_knob", globalPropertyi("tu154/custom/gauges/alt/vbe_fl_knob_left"))  -- flight level knob
defineProperty("vbe_mode", globalPropertyi("tu154/custom/gauges/alt/vbe_mode_left"))  -- meters/feet mode

defineProperty("vbe_flightlevel", globalPropertyi("tu154/custom/gauges/alt/vbe_flightlevel_left"))  -- 

defineProperty("mode_button", globalPropertyi("tu154/custom/gauges/alt/vbe_mode_but_left"))  -- mode button
...
defineProperty("vbe_on", globalPropertyi("tu154/custom/switchers/ovhd/vbe_1_on"))  -- power switcher

defineProperty("vbe_std", globalPropertyi("tu154/custom/gauges/alt/vbe_std_left"))  --   
-- time
