...
-- GPS installation flags belong exclusively to the SASL gps_source controller.
...
-- simDR_com1_sel = find_dataref("sim/cockpit2/radios/actuators/audio_selection_com1") -- Unused in this script and not referenced by other xTlua scripts.
simDR_com2_sel = find_dataref("sim/cockpit2/radios/actuators/audio_selection_com2")
-- simDR_com1_pwr = find_dataref("sim/cockpit2/radios/actuators/com1_power") -- Unused in this script and not referenced by other xTlua scripts.
-- simDR_com2_pwr = find_dataref("sim/cockpit2/radios/actuators/com2_power") -- Unused in this script and not referenced by other xTlua scripts.
...
-- simDR_mid_pan_flood = find_dataref("tu154/custom/lights/mid_panel_flood") -- Unused in this script and not referenced by other xTlua scripts.
...
-- pump_tank1_1 = find_dataref("tu154/custom/switchers/fuel/pump_tank1_1") -- Unused in this script and not referenced by other xTlua scripts.
-- pump_tank1_2 = find_dataref("tu154/custom/switchers/fuel/pump_tank1_2") -- Unused in this script and not referenced by other xTlua scripts.
-- pump_tank1_3 = find_dataref("tu154/custom/switchers/fuel/pump_tank1_3") -- Unused in this script and not referenced by other xTlua scripts.
-- pump_tank1_4 = find_dataref("tu154/custom/switchers/fuel/pump_tank1_4") -- Unused in this script and not referenced by other xTlua scripts.
...
-- rsbn_chan = find_dataref("tu154/custom/rsbn/channel") -- Unused in this script and not referenced by other xTlua scripts.
...
-- simDR_ap_type = find_dataref("sim/aircraft/autopilot/preconfigured_ap_type") -- Unused in this script and not referenced by other xTlua scripts.
...
-- simDR_airspeed = find_dataref("sim/flightmodel/position/indicated_airspeed") -- Unused in this script and not referenced by other xTlua scripts.
...
-- simDR_gforce_reset =  find_dataref("tu154/custom/buttons/misc/gforce_reset") -- Unused in this script and not referenced by other xTlua scripts.
...
-- simDR_parking_brake =  find_dataref("tu154/custom/controll/parking_brake") -- Unused in this script and not referenced by other xTlua scripts.
simDR_gear_blocks =  find_dataref("tu154/custom/anim/gear_blocks")  
-- test =  find_dataref("tu154/custom/gauges/ahz/pitch_corr_C") -- Unused in this script and not referenced by other xTlua scripts.
-- ahz_flag_l =  find_dataref("tu154/custom/gauges/ahz/ahz_flag_L") -- Unused in this script and not referenced by other xTlua scripts.
-- ahz_flag_r =  find_dataref("tu154/custom/gauges/ahz/ahz_flag_R") -- Unused in this script and not referenced by other xTlua scripts.
simDR_absu_pwr =  find_dataref("tu154/custom/absu_power_cc") 
simDR_cab_alt =  find_dataref("tu154/custom/gauges/airbleed/cabin_alt") 
-- simDR_cab_vvi =  find_dataref("tu154/custom/gauges/airbleed/cabin_vvi") -- Unused in this script and not referenced by other xTlua scripts.
...
-- cab_alt_new2 =  find_dataref("sim/cockpit2/pressurization/indicators/cabin_altitude_ft") -- Unused in this script and not referenced by other xTlua scripts.
...
-- simDR_gen_phase_sel = find_dataref("tu154/custom/switchers/eng/bus115_volt_phase_sel") -- Unused in this script and not referenced by other xTlua scripts.
...
-- Do not override automatic RXP detection with a forced GNS selection.
