...
defineProperty("tank1_1", globalPropertyi("tu154/custom/fuel/pump_tank1_1_work"))
defineProperty("tank1_2", globalPropertyi("tu154/custom/fuel/pump_tank1_2_work"))
defineProperty("tank1_3", globalPropertyi("tu154/custom/fuel/pump_tank1_3_work"))
defineProperty("tank1_4", globalPropertyi("tu154/custom/fuel/pump_tank1_4_work"))
...
defineProperty("start_sys_work", globalPropertyf("tu154/custom/start/start_sys_work")) --   
...
defineProperty("starter_rpm", globalPropertyf("sim/aircraft/engine/acf_starter_max_rpm_ratio")) --    0-1
defineProperty("jet_spoolup_time", globalPropertyf("sim/aircraft/engine/acf_spooltime_jet")) --   . 5   
...
asu_press = globalPropertyf("tu154/custom/asu/press")
