...
components = {
	...
	battery_logic{ -- battery 2
		bat_on_bus = globalPropertyi("tu154/custom/switchers/eng/bat2_on"), 
		bat_source = globalPropertyi("tu154/custom/elec/bat_is_source_2"),  
		bat_amp_bus = globalPropertyf("tu154/custom/elec/bat_amp_2"), 
		bat_amp_cc = globalPropertyf("tu154/custom/elec/bat_cc_2"),  
		bat_volt_bus = globalPropertyf("tu154/custom/elec/bat_volt_2"), 
	...
	battery_logic{ -- battery 3
		bat_on_bus = globalPropertyi("tu154/custom/switchers/eng/bat3_on"), 
		bat_source = globalPropertyi("tu154/custom/elec/bat_is_source_3"),  
		bat_amp_bus = globalPropertyf("tu154/custom/elec/bat_amp_3"), 
		bat_amp_cc = globalPropertyf("tu154/custom/elec/bat_cc_3"),  
		bat_volt_bus = globalPropertyf("tu154/custom/elec/bat_volt_3"), 
	...
	battery_logic{ -- battery 4
		bat_on_bus = globalPropertyi("tu154/custom/switchers/eng/bat4_on"), 
		bat_source = globalPropertyi("tu154/custom/elec/bat_is_source_4"),  
		bat_amp_bus = globalPropertyf("tu154/custom/elec/bat_amp_4"), 
		bat_amp_cc = globalPropertyf("tu154/custom/elec/bat_cc_4"),  
		bat_volt_bus = globalPropertyf("tu154/custom/elec/bat_volt_4"), 
		bus_volt = globalPropertyf("tu154/custom/elec/bus27_volt_right"),
