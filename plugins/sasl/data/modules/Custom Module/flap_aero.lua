...
-- Tu-154M v4.2.6: coupled flap/stabilizer pitch-moment correction.
-- CL and CD stay at the measured values. Only Cm follows the ACTUAL flap
-- angles, so its nose-down contribution fades together with the automatic
-- stabilizer nose-up incidence when the flaps retract.
...
-- 80 percent of the calculated C-selector coupling is compensated. The
-- remaining 20 percent is intentional: it avoids a pitch reversal and keeps
-- useful elevator margin for the F and A selector schedules.
local flap1_cm_tbl = {
	{-10, -0.4480},
	{0,   -0.4480},
	{15,  -0.4480},
