...
-- controls
defineProperty("wing_light", globalPropertyi("tu154/custom/switchers/eng/wing_light")) --     
--defineProperty("door_heat", globalPropertyi("tu154/custom/switchers/eng/door_heat")) --  
defineProperty("gear_fan", globalPropertyi("tu154/custom/switchers/eng/gear_fan")) --  
defineProperty("galley_heat", globalPropertyi("tu154/custom/switchers/eng/galley_heat")) --   
defineProperty("lavatory_heat", globalPropertyi("tu154/custom/switchers/eng/lavatory_heat")) --   
defineProperty("water_meter", globalPropertyi("tu154/custom/switchers/eng/water_meter")) --    
defineProperty("water_compressor_1", globalPropertyi("tu154/custom/switchers/eng/water_compressor_1")) --   
defineProperty("water_compressor_2", globalPropertyi("tu154/custom/switchers/eng/water_compressor_2")) --   
defineProperty("tail_temp_signal", globalPropertyi("tu154/custom/switchers/eng/tail_temp_signal")) --    
defineProperty("tail_temp_heat", globalPropertyi("tu154/custom/switchers/eng/tail_temp_heat")) --  

defineProperty("tail_temp_signal_control_1", globalPropertyi("tu154/custom/buttons/eng/tail_temp_signal_control_1")) --     
defineProperty("tail_temp_signal_control_2", globalPropertyi("tu154/custom/buttons/eng/tail_temp_signal_control_2")) --     

defineProperty("lamp_test_eng_up_1", globalPropertyi("tu154/custom/buttons/lamp_test_eng_up_1"))
defineProperty("lamp_test_eng_up_2", globalPropertyi("tu154/custom/buttons/lamp_test_eng_up_2"))

defineProperty("water_pressure", globalPropertyf("tu154/custom/gauges/eng/water_pressure")) --  

-- lamps
defineProperty("water_level_1", globalPropertyf("tu154/custom/lights/water_level_1")) --   1
defineProperty("water_level_12", globalPropertyf("tu154/custom/lights/water_level_12")) --   1
defineProperty("water_level_14", globalPropertyf("tu154/custom/lights/water_level_14")) --   1
defineProperty("water_level_0", globalPropertyf("tu154/custom/lights/water_level_0")) --   1

defineProperty("tail_temp_high", globalPropertyf("tu154/custom/lights/small/tail_temp_high")) -- 
defineProperty("lavatory_heat_lamp", globalPropertyf("tu154/custom/lights/small/lavatory_heat")) -- 
defineProperty("galley_heat_lamp", globalPropertyf("tu154/custom/lights/small/galley_heat")) -- 
...
-- results
defineProperty("water_lvl", globalPropertyf("tu154/custom/misc/water_level")) --  
