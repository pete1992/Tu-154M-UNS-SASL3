...
-- Main VSI textures
local scale_img = sasl.gl.loadImage("tcas_scale.png", 14, 6, 482, 482)
local needle_img = sasl.gl.loadImage("tcas_scale.png", 2, 478, 346, 32)
-- TCAS range scale textures
local scale_15 = sasl.gl.loadImage("tcas_marks.png", 18, 66, 72, 72)
local scale_10 = sasl.gl.loadImage("tcas_marks.png", 123, 65, 102, 102)
local scale_5 = sasl.gl.loadImage("tcas_marks.png", 276, 57, 194, 194)
local scale_3 = sasl.gl.loadImage("tcas_marks.png", 18, 293, 268, 174)
-- TCAS mode indication textures
local mc_img = sasl.gl.loadImage("tcas_marks.png", 0, 0, 53, 22)
local stby_img = sasl.gl.loadImage("tcas_marks.png", 8, 190, 110, 46)
local ta_img = sasl.gl.loadImage("tcas_marks.png", 144, 191, 83, 46)
local test_img = sasl.gl.loadImage("tcas_marks.png", 64, 0, 78, 22)
-- Range label textures
local range_15 = sasl.gl.loadImage("tcas_marks.png", 372, 399, 112, 24)
local range_10 = sasl.gl.loadImage("tcas_marks.png", 372, 364, 112, 24)
local range_5 = sasl.gl.loadImage("tcas_marks.png", 372, 329, 112, 24)
local range_3 = sasl.gl.loadImage("tcas_marks.png", 372, 293, 112, 24)
-- Relative altitude filter textures
local above_img = sasl.gl.loadImage("tcas_marks.png", 372, 433, 113, 22)
local below_img = sasl.gl.loadImage("tcas_marks.png", 371, 465, 115, 22)
-- Resolution advisory scale textures
local tcas_scale_climb = sasl.gl.loadImage("tcas_scale_climb.png", 14, 6, 482, 482)
local tcas_scale_climb_10 = sasl.gl.loadImage("tcas_scale_climb_10.png", 14, 6, 482, 482)
local tcas_scale_descend = sasl.gl.loadImage("tcas_scale_descend.png", 14, 6, 482, 482)
local tcas_scale_descend_10 = sasl.gl.loadImage("tcas_scale_descend_10.png", 14, 6, 482, 482)
local tcas_scale_maintain_lvl = sasl.gl.loadImage("tcas_scale_maintain_lvl.png", 14, 6, 482, 482)
local tcas_scale_not_climb = sasl.gl.loadImage("tcas_scale_not_climb.png", 14, 6, 482, 482)
local tcas_scale_not_climb_2 = sasl.gl.loadImage("tcas_scale_not_climb_2.png", 14, 6, 482, 482)
local tcas_scale_not_descend = sasl.gl.loadImage("tcas_scale_not_descend.png", 14, 6, 482, 482)
